...
*   **NFC Payment Simulation:** Tap a real NFC card or tag to trigger a realistic payment processing animation.
*   **Multilingual Support:** Fully localized in **English**, **Spanish (Español)**, **Dutch (Nederlands)**, and **Catalan (Català)**.
*   **Kid-Friendly UI:** Large buttons, high-contrast text, and colorful icons.

## 🛠 Technical Details

*   **Min SDK:** 24 (Android 7.0 Nougat)
*   **Architecture:** MVVM with Kotlin Coroutines and Flow.
*   **Navigation:** Android Navigation Component with a centralized `nav_graph`.
...
2.  While the **connection image is spinning** (during the 10-second processing phase), **tap the spinning image 3 times quickly**.
3.  The simulation will immediately transition to the **Failure** state.
